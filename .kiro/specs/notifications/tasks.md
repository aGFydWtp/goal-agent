...
- [ ] 3. コア: 通知文組み立て
- [ ] 3.1 (P) §9.1 チェックイン文と §9.3 アラート文の組み立てを実装する
...
- [ ] 4. コア: 配信オーケストレーション
- [ ] 4.1 (P) discord-gateway 送信ヘルパー経由の配信を実装する
...
- [ ] 5. コア: 週次スケジューラ
- [ ] 5.1 金曜16:30 週次 cron の冪等登録を実装する
...
- [ ] 7. 検証: クリティカルパスと境界遵守
- [ ] 7.1 週次通知クリティカルパスの E2E スモークテストを実装する
